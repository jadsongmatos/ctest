# External Tests for external-test-extractor.js

Testes de dependências externas usadas neste arquivo.

**Arquivo:** `/workspaces/ctest/src/lib/external-test-extractor.js`
...
**Funções usados neste arquivo:** basename, sep
...
**Funções usados neste arquivo:** existsSync, writeFileSync, readFileSync
